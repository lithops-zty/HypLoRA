#!/bin/bash
# =============================================================================
# LoRA (baseline) evaluation on MIMIC-IV lab-value prediction — Qwen3-8B
#
...
LORA_WEIGHTS="${LORA_WEIGHTS:-./trained_models/qwen3-8b-lora-medical}"
OUTPUT_FILE="${OUTPUT_FILE:-./results/qwen3-8b-lora-results.json}"
